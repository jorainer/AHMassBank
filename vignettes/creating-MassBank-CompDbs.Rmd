...
untargeted mass spectrometry data. The `CompoundDb` Bioconductor package
supports conversion of MassBank data into the `CompDb` (SQLite) format which
enables a simplified distribution of the resource and easy integration into
